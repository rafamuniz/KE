...
Public Class clsCust
    ...
    Public Function getCusts() As DataSet
        Dim sql As String
    ...
    End Function
    Public Function getCust(ByVal id As Long) As Boolean
        Dim sql As String
        Dim ds As New DataSet
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                Try
                    With ds.Tables(0).Rows(0)
                        oElements.custName = clsGeneral.IsNull(.Item("custName"))
                        oElements.custContact = clsGeneral.IsNull(.Item("custContact"))
                        oElements.custStatus = clsGeneral.IsNull(.Item("custStatus"))
                    End With
                Catch ex As Exception
                    ' error
                    Return False
    ...
    End Function
    Public Function AddCust() As Boolean
        ...
        Try 'to add this record to the relations table
            With oElements
                ...
                .custID = clsGeneral.ActionQuery(strSQL, True)
                If .custID <= 0 Then
                    ' error adding rec
                    Return False
                End If
        ...
        oRelation.oElements.relID1 = oElements.custID
        ...
        Return True
    End Function
    Public Function updCust(ByVal id As Long) As Boolean
