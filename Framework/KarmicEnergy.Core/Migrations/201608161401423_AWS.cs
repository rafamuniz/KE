    ...
    public partial class AWS : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.OperatorTypes", t => t.OperatorTypeId, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Units", t => t.FromUnitId, cascadeDelete: true)
                .ForeignKey("dbo.Units", t => t.ToUnitId, cascadeDelete: true)
