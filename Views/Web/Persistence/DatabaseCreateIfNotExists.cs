...
namespace KarmicEnergy.Web.Persistence
{
    public class DatabaseCreateIfNotExists : CreateDatabaseIfNotExists<ApplicationContext>
    {
        ...
        {
            CreateUser(context, "Karmic Energy", "karmicenergy@ke.com", "KarmicEnergy10$", "SuperAdmin");
            CreateUser(context, "KE", "ke@karmicenergy.com", "KarmicEnergy10$", "SuperAdmin");
            CreateUser(context, "Rafael Muniz", "muniz@karmicenergy.com", "KEMuniz11$", "SuperAdmin");
        }

        private void CreateUser(ApplicationContext context, String name, String email, String password, String role)
        {
